...
//
#include "../../include/rendering/VulkanEngineModel.h"
...
namespace std {
    template<>
    struct hash<VulkanEngineModel::Vertex> {
        size_t operator()(VulkanEngineModel::Vertex const &vertex) const {
            size_t seed = 0;
...
VulkanEngineModel::VulkanEngineModel(VulkanEngineDevice &core, const VulkanEngineModel::Builder &builder) : engineDevice{core} {
...
void VulkanEngineModel::createVertexBuffers(const std::vector<Vertex> &vertices) {
    ...
    VulkanEngineBuffer stagingBuffer{
            engineDevice,
            vertexSize,
            vertexCount,
    ...
    vertexBuffer = std::make_unique<VulkanEngineBuffer>(
            engineDevice,
            vertexSize,
            vertexCount,
...
void VulkanEngineModel::createIndexBuffer(const std::vector<uint32_t> &indices) {
    ...
    indexBuffer = std::make_unique<VulkanEngineBuffer>(
            engineDevice,
            indexSize,
            indexCount,
