...
//
#include "../../include/rendering/VulkanEngineDevice.h"
...
std::vector<const char *> VulkanEngineDevice::getRequiredExtensions() {
    ...
    CORE_INFO("Found {} VulkanEngineDevice instance extensions\n", ext_count);
...
void VulkanEngineDevice::hasSDLRequiredInstanceExtensions() {
    ...
    CORE_INFO("Available Vulkan extensions: \n");
    ...
    CORE_INFO("Required Vulkan extensions: \n");
