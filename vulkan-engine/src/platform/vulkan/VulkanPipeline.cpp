...
namespace VulkanEngine {
    ...
    VulkanPipeline::VulkanPipeline(VulkanDevice &engineDevice, const std::string &vertFilePath, const std::string &fragFilePath, const PipelineConfigInfo &configInfo)
    ...
    void VulkanPipeline::CreateShaderModule(const std::vector<char> &code, VkShaderModule *shaderModule) {
        ...
        CORE_ASSERT(vkCreateShaderModule(engineDevice_.GetDevice(), &createInfo, nullptr, shaderModule) == VK_SUCCESS, "Failed to create shader module")
    }

    void VulkanPipeline::DefaultPipelineConfig(PipelineConfigInfo &configInfo) {
