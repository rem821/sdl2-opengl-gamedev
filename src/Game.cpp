...
for (int i = 0; i < 50; i++) {
    ...
    GameObject::Map cubeFaces = cube.getCubeFaces(0.f, 0.f, 0.f, false, false, false, false, false, false);

    GameObject::Map cube2Faces = cube.getCubeFaces(1.f, 0.f, 0.f, true, true, true, true, false, true);
    GameObject::Map cube3Faces = cube.getCubeFaces(0.f, 1.f, 0.f, false, true, true, true, true, true);
    GameObject::Map cube4Faces = cube.getCubeFaces(0.f, 0.f, -1.f, true, true, true, false, true, true);

    GameObject::Map cube5Faces = cube.getCubeFaces(-1.f, 0.f, 0.f, true, true, true, true, true, false);
    GameObject::Map cube6Faces = cube.getCubeFaces(0.f, -1.f, 0.f, true, false, true, true, true, true);
    GameObject::Map cube7Faces = cube.getCubeFaces(0.f, 0.f, 1.f, true, true, false, true, true, true);

    gameObjects.merge(cubeFaces);

    gameObjects.merge(cube2Faces);
    gameObjects.merge(cube3Faces);
    gameObjects.merge(cube4Faces);

    gameObjects.merge(cube5Faces);
    gameObjects.merge(cube6Faces);
    gameObjects.merge(cube7Faces);
      */
