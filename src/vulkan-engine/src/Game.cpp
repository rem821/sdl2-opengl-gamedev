...
void Game::run() {
    ...
    //viewerObject.transform.translation = fromWorldToCamera({0, 50, 500});
    viewerObject.transform.translation = {(MAP_HEIGHT / 2) + (CHUNK_SIZE / 2), -80.0f, (MAP_WIDTH / 2) + (CHUNK_SIZE / 2)};
