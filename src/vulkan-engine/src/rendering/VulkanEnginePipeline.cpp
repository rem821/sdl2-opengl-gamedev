...
VulkanEnginePipeline::VulkanEnginePipeline(VulkanEngineDevice &engineDevice, const std::string &vertFilePath,
...
void VulkanEnginePipeline::createGraphicsPipeline(const std::string &vertFilePath, const std::string &fragFilePath,
    ...
    //fmt::print("Vertex shader code size: {}, Fragment shader code size: {}\n", vertCode.size(), fragCode.size());
...
void VulkanEnginePipeline::defaultPipelineConfig(PipelineConfigInfo &configInfo) {
    ...
    configInfo.bindingDescriptions = VulkanEngineModel::Vertex::getBindingDescriptions();
    configInfo.attributeDescriptions = VulkanEngineModel::Vertex::getAttributeDescriptions();
}
...
void VulkanEnginePipeline::enableAlphaBlending(PipelineConfigInfo &configInfo) {
